package springbootbackendapirest2.apirest.controllers;
...
import springbootbackendapirest2.models.services.IClienteService;
...
public class ClienteRestController {
	...
	public ResponseEntity<?> show(@PathVariable Long id) {
		...
		if(cliente == null) {
			response.put("mensaje", "El cliente de id".concat(id.toString().concat(" no existe en la base de datos.")));
	...
	public ResponseEntity<?> update(@Valid @RequestBody Cliente cliente, BindingResult result, @PathVariable Long id) {
		...
		if(clienteActual == null) {
			response.put("mensaje", "No se pudo modificar el cliente de id ".concat(id.toString()));
			return new ResponseEntity<Map<String, Object>>(response, HttpStatus.NOT_FOUND);
		}
		try {
	...
	public ResponseEntity<?> delete(@PathVariable Long id) {
		...
		response.put("mensaje", "Borrado realizado con éxito.");
